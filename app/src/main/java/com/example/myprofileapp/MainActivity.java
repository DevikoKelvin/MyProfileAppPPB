...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        gotoMaps.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Uri gmmIntentUri = Uri.parse("geo:0,0?q=Jalan+Gedong+Songo+Dalam+No+12");
...
//                startActivity(Intent.createChooser(mapIntent, "Choose app.."));
        ...
        gotoCall.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                callIntent.setData(Uri.parse("tel:081328532630"));
        ...
        gotoMail.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto","vycrosver@live.com", null));
